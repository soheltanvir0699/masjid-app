...
def schedule_api():
    ...
    payload = {"app_id": "5aac78d8-4ad3-4314-bfae-dbed8d042a86",
               ...
               "data": {"body": "Hello my friend! we added a new post!", "title": "New post", },
               "headings": {"en": "Fajr"}}
    payloadAsr = {"app_id": "5aac78d8-4ad3-4314-bfae-dbed8d042a86",
                  "include_player_ids": AsrplayerID,
                  "contents": {"en": "Salat Start",
                               "ru": "Lorem ipsum dolor amit"},
                  "data": {"body": "Hello my friend! we added a new post!", "title": "New post", },
                  "headings": {"en": "Asr"}}
    payloadMaghrib = {"app_id": "5aac78d8-4ad3-4314-bfae-dbed8d042a86",
                      "include_player_ids": MagribplayerID,
                      "contents": {"en": "Salat Start",
                                   "ru": "Lorem ipsum dolor amit"},
                      "data": {"body": "Hello my friend! we added a new post!", "title": "New post", },
                      "headings": {"en": "Maghrib"}}
    payloadDhuhr = {"app_id": "5aac78d8-4ad3-4314-bfae-dbed8d042a86",
                    "include_player_ids": DhuhrplayerID,
                    "contents": {"en": "Salat Start",
                                 "ru": "Lorem ipsum dolor amit"},
                    "data": {"body": "Hello my friend! we added a new post!", "title": "New post", },
                    "headings": {"en": "Dhuhr"}}
    payloadIsha = {"app_id": "5aac78d8-4ad3-4314-bfae-dbed8d042a86",
