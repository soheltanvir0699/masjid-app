...
class Salat_Time_List(models.Model):
    ...
    Fajr = models.DateTimeField(auto_created=False, blank=False, null=False)
    Sunrise = models.DateTimeField(auto_created=False, blank=True, null=True)
    Dhuhr = models.DateTimeField(auto_created=False, blank=False, null=False)
    Asr = models.DateTimeField(auto_created=False, blank=False, null=False)
    Sunset = models.DateTimeField(auto_created=False, blank=True, null=True)
    Maghrib = models.DateTimeField(auto_created=False, blank=False, null=False)
    Isha = models.DateTimeField(auto_created=False, blank=False, null=False)
    Imsak = models.DateTimeField(auto_created=False, blank=True, null=True)
    create_at = models.DateTimeField(verbose_name='date joined', auto_now_add=True)
